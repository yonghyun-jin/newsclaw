      ...
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="text-center space-y-4">
          ...
          <div className="flex justify-center gap-4">
            <a 
              href="/news" 
              className="inline-flex items-center gap-2 px-4 py-2 bg-green-100 text-green-700 rounded-md hover:bg-green-200 transition-colors"
            >
              📰 View News Archive
            </a>
            <a 
              href="/admin/debug" 
              className="inline-flex items-center gap-2 px-4 py-2 bg-blue-100 text-blue-700 rounded-md hover:bg-blue-200 transition-colors"
            >
              🔧 Debug NewsAPI Issues
            </a>
          </div>
        </div>
